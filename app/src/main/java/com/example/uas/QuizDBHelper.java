...
public class QuizDBHelper extends SQLiteOpenHelper {
    ...
    private void insertQuestions() {
        for(Question q : mQuestionList) {
            ...
            contentValues.put(QuizContract.QuestionsTable.COLUMN_CATEGORY, q.getmCategory());
    ...
    public ArrayList<Question> getAllQuestions(String categoryID) {
        ...
        String SELECT_TABLE_QUERY = "SELECT * FROM " + QuizContract.QuestionsTable.TABLE_NAME + " WHERE " + QuizContract.QuestionsTable.COLUMN_CATEGORY + " = \"" + categoryID + "\"";
